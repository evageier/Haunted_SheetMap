    ...
    <script>
        ...
        $(document).ready(function () {
            $.ajax({
                ...
                url: 'https://docs.google.com/spreadsheets/d/{1U3QxR9is_88OTZX4zZvRVXI3VXkpCUrROP3JwvwfbkE}/gviz/tq?tqx=out:csv&sheet={cal_haunted_places}', // replace the text in single quotes with the link to your CSV file
                dataType: "text",
